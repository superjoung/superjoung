<h1 align="center">정회륜</h1>

<p align="center"><strong>게임 클라이언트 개발자</strong></p>

<p align="center">
  상태와 생명주기를 설계합니다.<br />
  Unity와 C#으로 전투·입력·UI의 실행 흐름을 구현하고, 재진입·중단·반환 시점까지 코드로 설명합니다.
</p>
...
<p align="center">
  ...
  <a href="https://www.notion.so/Joung-HowiRyun-31b59b9ce07280a0bf2bf1223dd0cddd?source=copy_link"><img src="https://img.shields.io/badge/%ED%8F%AC%ED%8A%B8%ED%8F%B4%EB%A6%AC%EC%98%A4-4F6F54?style=flat-square&logo=notion&logoColor=white" alt="노션 포트폴리오" /></a>
</p>

<p align="center">
  <a href="#개발할-때-중요하게-보는-것">개발 기준</a> ·
  <a href="#대표-프로젝트">대표 프로젝트</a> ·
  <a href="#경험과-수상">경험과 수상</a>
</p>
...
> **턴제 전략 로그라이트 · 팀 리드 / 전투·UI·개발 도구 구현**<br />
...
- **확인** [노션에서 기술 사례 보기](https://www.notion.so/Joung-HowiRyun-31b59b9ce07280a0bf2bf1223dd0cddd?source=copy_link)

### 02. 미기록 구역

> **2D 공포 감시 게임 · 날짜 진행과 입력·연출 상태 설계**<br />
...
- **확인** [GitHub에서 코드 보기](https://github.com/superjoung/UnopenedArea-2026-06-19_23-16-59)

### 03. CenterFall

> **2D 액션 퍼즐 · 트윈 중단과 오브젝트 반환 경로 정리**<br />
...
- **확인** [GitHub에서 코드 보기](https://github.com/superjoung/CenterFall)

### 04. Guess

> **3D 추리 어드벤처 · LLM을 제외한 Unity 클라이언트 구현**<br />
...
- **확인** [기술 사례 보기](https://github.com/superjoung/Portfolio-Guess) · [원본 코드 보기](https://github.com/superjoung/2025-1-LLMJoljakGame)
...
[asss6868@naver.com](mailto:asss6868@naver.com) · [노션 포트폴리오](https://www.notion.so/Joung-HowiRyun-31b59b9ce07280a0bf2bf1223dd0cddd?source=copy_link)
